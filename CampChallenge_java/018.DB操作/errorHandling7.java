 ...
 * @author 晴嵩
 */
@WebServlet(urlPatterns = {"/errorHandling7"})
public class errorHandling7 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                String sql = "UPDATE profiles SET age=50 WHERE profilesID=6;";
            ...
            out.println("<html>");
            out.println("<head>");
           //out.println("<title>Servlet errorHandling7</title>");            
            out.println("</head>");
            out.println("<body>");
           // out.println("<h1>Servlet errorHandling7 at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
