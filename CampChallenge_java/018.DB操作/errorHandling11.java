 ...
 * @author 晴嵩
 */
@WebServlet(urlPatterns = {"/errorHandling11"})
public class errorHandling11 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                //SQL文の作成
                String sql = "UPDATE profiles SET profilesID="
                        + Integer.parseInt(ID) + 
                        ",name=\"" + name +
                         "\",tel=\"" + tel +
                        "\",age=" + Integer.parseInt(age) + 
                        ",birthday=\""+ year + "-" + month + "-" + day + "\"" +
                        "WHERE profilesID=" + Integer.parseInt(ID1) +  ";";
